...
fs.img: mkfs README2 README README3 README4 README5 mem_req.txt $(UPROGS)
	./mkfs fs.img README2 README README3 README4 README5 mem_req.txt $(UPROGS)


nvme.img: 
	dd if=/dev/zero of=nvme.img bs=1M count=32
	./mkfs nvme.img README2 README README3 README4 README5 $(UPROGS)
