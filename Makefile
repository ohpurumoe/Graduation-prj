...
fs.img: mkfs README README2 README3 README4 README5 README6 README7 $(UPROGS)
	./mkfs fs.img README README2 README3 README4 README5 README6 README7 $(UPROGS)
...
clean: 
	...
	*.o *.d *.asm *.sym vectors.S bootblock entryother \
	...
	xv6memfs.img mkfs .gdbinit nvme.img \
	$(UPROGS)
...
-device nvme,serial=deadbeef,drive=nvme -smp $(CPUS) -m 8192  
qemu: fs.img xv6.img
...
qemu-nox: fs.img xv6.img nvme.img
